...
public class GroovyConditionShell implements ConditionShell {
    ...
    private static SecureASTCustomizer createSecureASTCustomizer() {
        ...
        secureASTCustomizer.setStarImportsWhitelist(Arrays.asList(new String[] { "org.crsh.command.*", "org.crsh.cli.*",
                "org.crsh.groovy.*", "com.ge.predix.acs.commons.policy.condition.*" }));
        ...
        secureASTCustomizer.setReceiversClassesWhiteList(Arrays.asList(new Class[] { Boolean.class, Collection.class,
                Integer.class, Iterable.class, Object.class, Set.class, String.class }));
