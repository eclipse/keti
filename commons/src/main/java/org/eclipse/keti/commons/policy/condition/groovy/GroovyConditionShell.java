...
package org.eclipse.keti.commons.policy.condition.groovy;
...
import org.eclipse.keti.commons.policy.condition.AbstractHandler;
import org.eclipse.keti.commons.policy.condition.ConditionParsingException;
import org.eclipse.keti.commons.policy.condition.ConditionScript;
import org.eclipse.keti.commons.policy.condition.ConditionShell;
...
public class GroovyConditionShell implements ConditionShell {
     ...
     * (non-Javadoc)
     *
     * @see org.eclipse.keti.commons.conditions.ConditionShell#parse(java.lang. String )
     */
    @Override
    ...
    private static SecureASTCustomizer createSecureASTCustomizer() {
        ...
        secureASTCustomizer.setStarImportsWhitelist(Arrays.asList(
                new String[] { "org.crsh.command.*", "org.crsh.cli.*", "org.crsh.groovy.*",
                        "org.eclipse.keti.commons.policy.condition.*" }));
    ...
    private ASTTransformationCustomizer createASTTransformationCustomizer() {
        ...
        return new ASTTransformationCustomizer(singletonMap("extensions",
                singletonList("org.eclipse.keti.commons.policy.condition.groovy.GroovySecureExtension")),
                CompileStatic.class);
    }
}
