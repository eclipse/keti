...
public class GroovySecureExtension extends AbstractTypeCheckingExtension {
    ...
    public void onMethodSelection(final Expression expression, final MethodNode target) {
        ...
        if ((!"org.eclipse.keti.commons.policy.condition.AbstractHandler".equals(target.getDeclaringClass().getName()))
                && (!"org.eclipse.keti.commons.policy.condition.AbstractHandlers"
                .equals(target.getDeclaringClass().getName()))
                && (!"org.eclipse.keti.commons.policy.condition.ResourceHandler"
                .equals(target.getDeclaringClass().getName()))
                && (!"org.eclipse.keti.commons.policy.condition.SubjectHandler"
                .equals(target.getDeclaringClass().getName()))
                && (!"org.eclipse.keti.commons.policy.condition.groovy.AttributeMatcher"
