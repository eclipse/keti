...
internal fun getAdapterErrorMessage(adapterEndpoint: String): String {
    return MessageFormat.format(
        "Couldn''t get attributes from the adapter with endpoint ''{0}''",
        adapterEndpoint
    )
}

internal fun getStorageErrorMessage(id: String): String {
