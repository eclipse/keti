...
private const val HEARTBEAT_URI_REGEX = "\\A/monitoring/heartbeat/??\\Z"
...
@Component
class MonitoringHttpMethodsFilter : AbstractHttpMethodsFilter(uriPatternsAndAllowedHttpMethods())
