...
import static org.eclipse.keti.privilege.management.dao.GraphResourceRepository.RESOURCE_ID_KEY;
import static org.eclipse.keti.testutils.XFiles.ASCENSION_ATTRIBUTES;
import static org.eclipse.keti.testutils.XFiles.ASCENSION_ID;
import static org.eclipse.keti.testutils.XFiles.BASEMENT_ATTRIBUTES;
import static org.eclipse.keti.testutils.XFiles.BASEMENT_SITE_ID;
import static org.eclipse.keti.testutils.XFiles.DRIVE_ATTRIBUTES;
import static org.eclipse.keti.testutils.XFiles.DRIVE_ID;
import static org.eclipse.keti.testutils.XFiles.EVIDENCE_IMPLANT_ATTRIBUTES;
import static org.eclipse.keti.testutils.XFiles.EVIDENCE_IMPLANT_ID;
import static org.eclipse.keti.testutils.XFiles.EVIDENCE_SCULLYS_TESTIMONY_ID;
import static org.eclipse.keti.testutils.XFiles.JOSECHUNG_ID;
import static org.eclipse.keti.testutils.XFiles.SCULLYS_TESTIMONY_ATTRIBUTES;
import static org.eclipse.keti.testutils.XFiles.SITE_BASEMENT;
import static org.eclipse.keti.testutils.XFiles.TOP_SECRET_CLASSIFICATION;
import static org.eclipse.keti.testutils.XFiles.TYPE_MONSTER_OF_THE_WEEK;
...
import org.eclipse.keti.config.GraphConfig;
import org.eclipse.keti.model.Attribute;

import org.eclipse.keti.rest.Parent;
...
public class GraphResourceRepositoryTest {
     ...
     * org.eclipse.keti.privilege.management.dao.GraphGenericRepository.save(GraphGenericRepository.java:221) at
     * org.eclipse.keti.privilege.management.dao.GraphResourceRepositoryTest.saveWithRetry(
     * GraphResourceRepositoryTest.java:554) at
     * org.eclipse.keti.privilege.management.dao.GraphSubjectRepositoryTest.saveWithRetry(GraphSubjectRepositoryTest.
     * java:277) at
     * org.eclipse.keti.privilege.management.dao.GraphSubjectRepositoryTest.persistSubjectToZoneAndAssert(
     * GraphSubjectRepositoryTest.java:246) at
     * org.eclipse.keti.privilege.management.dao.GraphSubjectRepositoryTest.persistRandomSubjectToZone1AndAssert(
     * GraphSubjectRepositoryTest.java:221) at
     * org.eclipse.keti.privilege.management.dao.GraphSubjectRepositoryTest.testGetByZoneAndSubjectIdentifier(
