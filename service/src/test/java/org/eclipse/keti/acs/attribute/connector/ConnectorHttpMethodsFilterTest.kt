...
class ConnectorHttpMethodsFilterTest {

    @InjectMocks
    private lateinit var attributeConnectorController: AttributeConnectorController
    ...
    fun setup() {
        ...
        this.mockMvc = MockMvcBuilders.standaloneSetup(this.attributeConnectorController)
            .addFilters<StandaloneMockMvcBuilder>(ConnectorHttpMethodsFilter()).build()
    }
