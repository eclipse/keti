...
package org.eclipse.keti.attribute.readers;

import java.util.Collections;
import java.util.Set;

import org.apache.commons.lang3.RandomStringUtils;
import org.eclipse.keti.attribute.cache.AttributeCache;
...
public class ExternalSubjectAttributeReaderTest {
    ...
    public void testGetAttributesThatAreToLarge(final int maxNumberOfAttributes, final int maxSizeOfAttributesInBytes)
            throws Exception {
        ExternalAttributeReaderHelper.setupMockedAdapterResponse(this.externalSubjectAttributeReader,
                this.attributeCache, IDENTIFIER);
        ReflectionTestUtils.setField(this.externalSubjectAttributeReader, "maxNumberOfAttributes",
