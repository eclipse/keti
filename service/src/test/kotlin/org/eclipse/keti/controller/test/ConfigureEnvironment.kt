...
private fun setPropertyIfNotExist(
    name: String,
    value: String
) {
...
object ConfigureEnvironment {
    init {
        setPropertyIfNotExist("UAA_LOCAL_PORT", "8080")
        setPropertyIfNotExist(
            "ACS_DEFAULT_ISSUER_ID", "http://acs.localhost:" + System.getenv("UAA_LOCAL_PORT") + "/uaa"
        )
