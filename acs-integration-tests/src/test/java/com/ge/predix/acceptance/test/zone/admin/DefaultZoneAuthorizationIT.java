...
public class DefaultZoneAuthorizationIT extends AbstractTestNGSpringContextTests {
    ...
    public void testAccessGlobalResourceWithZoneIssuer() throws Exception {
        ...
        String acsZone2Url = this.zoneHelper.getZone2Url();

        // Write a resource to zone2. This should work
        ResponseEntity<Object> responseEntity = this.privilegeHelper.postResources(zone2AcsTemplate, acsZone2Url,
                new BaseResource("/sites/sanramon"));
        ...
        try {
            zone2AcsTemplate.getForEntity(this.zoneHelper.getAcsBaseURL() + "/v1/zone/" + this.zone2Name, Zone.class);
