...
public class PolicyEvaluationStepsDefinitions extends AbstractTestNGSpringContextTests {
    ...
    public void policyDefinitionAllowsAccessToAll() throws Throwable {
        this.testPolicyName = this.policyHelper.setTestPolicyWithDefaultTemplate("src/test/resources/permit-all.json");
    }
    ...
    public void policyDefinitionAllowsAccessToNone() throws Throwable {
        this.testPolicyName = this.policyHelper.setTestPolicyWithDefaultTemplate("src/test/resources/deny-all.json");
    }

    @When("^Any evaluation request$")
    public void anyEvaluationRequest() throws Throwable {
        this.policyEvaluationResponse = this.policyHelper
                .sendEvaluationRequest(this.policyHelper.createRandomEvalRequest());
    }
    ...
    public void policyDefinitionAllowsAccessToOnlyAdminsUsingCondition(final String subjectAttribute) throws Throwable {
        this.testPolicyName = this.policyHelper.setTestPolicyWithDefaultTemplate(
    ...
    public void evaluationRequestWithSubjectAttribute(final String subjectAttribute) throws Throwable {
        ...
        this.policyEvaluationResponse = this.policyHelper.sendEvaluationRequest(this.policyHelper
                .createEvalRequest(DEFAULT_ACTION, DEFAULT_SUBJECT_ID, DEFAULT_RESOURCE_IDENTIFIER, subjectAttributes));
    }
    ...
    public void evaluationRequestForResourceWithSubjectAttribute(final String resourceIdentifier,
        ...
        this.policyEvaluationResponse = this.policyHelper.sendEvaluationRequest(this.policyHelper
                .createEvalRequest(DEFAULT_ACTION, DEFAULT_SUBJECT_ID, resourceIdentifier, subjectAttributes));
    }
    ...
    public void policyDefinitionAllowsAccessToOnlyAdminsUsingMatcher() throws Throwable {
        this.testPolicyName = this.policyHelper
                .setTestPolicyWithDefaultTemplate("src/test/resources/permit-admin-only-using-matcher-policy-set.json");
    }
    ...
    public void acs_has_subject_attribute(final String attributeName, final String value) throws Throwable {
        this.privilegeHelper.putSubjectWithDefaultTemplate(DEFAULT_SUBJECT_IDENTIFIER,
    ...
    public void an_existing_policy_with_no_defined_action() throws Throwable {
        this.testPolicyName = this.policyHelper
                .setTestPolicyWithDefaultTemplate("src/test/resources/no-defined-action-policy-set.json");
    }
    ...
    public void an_existing_policy_set_stored_in_ACS_with_multiple_actions() throws Throwable {
        this.testPolicyName = this.policyHelper
                .setTestPolicyWithDefaultTemplate("src/test/resources/multiple-actions-defined-policy-set.json");
    }
    ...
    public void an_existing_policy_set_stored_in_ACS_with_a_single_action() throws Throwable {
        this.testPolicyName = this.policyHelper
                .setTestPolicyWithDefaultTemplate("src/test/resources/single-action-defined-policy-set.json");
    }
    ...
    public void an_existing_policy_with_empty_defined_action() throws Throwable {
        this.testPolicyName = this.policyHelper
                .setTestPolicyWithDefaultTemplate("src/test/resources/single-empty-action-defined-policy-set.json");
    }
    ...
    public void an_existing_policy_with_null_defined_action() throws Throwable {
        this.testPolicyName = this.policyHelper
                .setTestPolicyWithDefaultTemplate("src/test/resources/single-null-action-defined-policy-set.json");
    }
    ...
    public void a_policy_evaluation_is_requested_with_an_HTTP_action_not_matching() throws Throwable {
        List<Attribute> subjectAttributes = new ArrayList<Attribute>();
        this.policyEvaluationResponse = this.policyHelper.sendEvaluationRequest(this.policyHelper.createEvalRequest(
                NOT_MATCHING_ACTION, DEFAULT_SUBJECT_ID, DEFAULT_RESOURCE_IDENTIFIER, subjectAttributes));
    }
    ...
    public void evaluation_request_which_has_subject_attribute_which_are_null() throws Throwable {
        this.policyEvaluationResponse = this.policyHelper.sendEvaluationRequest(this.policyHelper
                .createEvalRequest(NOT_MATCHING_ACTION, DEFAULT_SUBJECT_ID, DEFAULT_RESOURCE_IDENTIFIER, null));
    }
